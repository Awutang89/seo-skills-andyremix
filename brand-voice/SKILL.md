...
On every invocation, check if brand context already exists:
...
Check each file:
- If `voice-profile.md` exists → load it and ask: "I found an existing voice profile. Do you want to revise it, or start fresh?"
- If missing → proceed to Extract or Build mode as normal

Display on load:
```
BRAND CONTEXT
✓ voice-profile.md found — revision mode available
✗ positioning.md — not found
✗ audience.md — not found
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
SKILL: brand-voice | PROJECT: [project-name] | v[n]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Brand voice is the foundation — every other skill reads it. Once your voice profile is complete:

- **Positioning:** Run `/positioning-angles` to find the angle that makes this brand stand out
- **Keywords:** Run `/keyword-research` to find search demand aligned with this voice
- **Copy:** Run `/direct-response-copy` to write in this voice immediately
