...
*This mode is part of the Marketing & SEO Skills creative engine. It is loaded by `creative/SKILL.md` when the user selects mode 1 (Product Photos). All model configurations are maintained in `references/MODEL_REGISTRY.md` — never hardcode model IDs in this file.*
