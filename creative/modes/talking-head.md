...
*This mode is part of the Marketing & SEO Skills creative engine. Model configurations are maintained in `references/MODEL_REGISTRY.md`. When model schemas change upstream, MODEL_REGISTRY.md is updated first, then this mode file is updated to match.*
