# Model Registry — Marketing & SEO Skills
...
*This registry is maintained as part of the Marketing & SEO Skills creative engine. When model schemas change upstream, update this file first, then update any mode files that reference the changed model.*
