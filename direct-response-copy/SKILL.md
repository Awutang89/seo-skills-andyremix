...
Before writing anything, identify the output format:

| # | Format | Use when |
|---|--------|----------|
| 1 | **Landing page** | Full page structure, AIDA arc, multiple sections |
| 2 | **Email** | Single email, conversational, one CTA |
| 3 | **Ad** | Short-form, hook + benefit + CTA, platform-aware |
| 4 | **Social post** | Platform-native, built for scroll, organic voice |
| 5 | **CTA** | Button text, micro-copy, friction reducers |
| 6 | **Headline pack** | 5-10 headline variants, no body copy |

If not specified, ask: "What format do you need? (1-6 above, or describe)"

Each format has different length, rhythm, and structure requirements. Don't write a landing page when someone needs a headline.

---

## Variant generation protocol

Never deliver a single option. Always generate variants so the user can choose or test.

**Minimum output standards by format:**

| Format | Headlines | Body/Opening variants | CTA variants |
|--------|-----------|----------------------|--------------|
| Landing page | 5 minimum | 2 (different angles) | 3 minimum |
| Email | 3 subject lines | 1 full email | — |
| Ad | 5 minimum | 2-3 body variants | 2 minimum |
| Social post | — | 3 full variants | — |
| CTA | — | — | 5 minimum |
| Headline pack | 8-10 | — | — |

**After delivering variants:**
- Label each option clearly (Option A, Option B, etc.)
- State the strategic difference between options in one line
- Recommend a starting point: "I'd test Option B first because [reason]"
...
Before delivering any copy, score it across 7 dimensions. Total = /70. Target: 56+ (80%).

| Dimension | 1-10 | What to check |
|-----------|------|---------------|
| **Headline strength** | /10 | Does it stop the scroll? Specific? Curiosity or self-interest? |
| **Opening hook** | /10 | First sentence earns the second? No generic opener? |
| **Specificity** | /10 | Numbers, names, timeframes? No vague claims? |
| **Voice match** | /10 | Sounds like the brand? Human, not AI? Contractions? |
| **Transformation clarity** | /10 | Is the before/after viscerally clear? |
| **Objection handling** | /10 | Does it pre-answer the "but..." reader is thinking? |
| **CTA strength** | /10 | Benefit-oriented? One action? Friction reducers below? |

**Scoring guide:**
- 63-70 (90%+): Ship it
- 56-62 (80-89%): Ship with minor tweaks
- 49-55 (70-79%): Needs one major revision
- Below 49: Rewrite before delivering

**After scoring:**
- Show the score table with your ratings
- Flag any dimension below 7
- State what you'd fix to improve those dimensions

---

## A/B testing suggestions

After delivering copy, always suggest 2-3 A/B tests. Focus on the highest-leverage variables.

**Standard test suggestions by format:**

**Landing page — test in this order:**
1. Headline (highest impact — 19.5x variance possible)
2. Opening paragraph (second-highest drop-off point)
3. CTA button text
4. Hero image vs. no image
5. Pricing section framing

**Email — test in this order:**
1. Subject line (open rate is gating metric)
2. From name (personal vs. brand)
3. Send time
4. CTA placement (above fold vs. end)
5. Length (short vs. long)

**Ad — test in this order:**
1. Hook / first line
2. Visual (static vs. video, lifestyle vs. product)
3. CTA
4. Audience targeting (separate from copy test)

**How to frame test suggestions:**

```
Suggested A/B tests for this piece:

Test 1 — [What to test]: "[Control]" vs. "[Variant]"
Hypothesis: [Why you think the variant might win]
Metric: [What to measure]

Test 2 — [What to test]: "[Control]" vs. "[Variant]"
Hypothesis: [Why you think the variant might win]
Metric: [What to measure]
```

Always recommend the highest-leverage test first.
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
SKILL: direct-response-copy | PROJECT: [project-name] | v[n]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Copy is one asset. Once the core piece is done:

- **Email:** Run `/email-sequences` to build a follow-up sequence
- **Angles:** Run `/positioning-angles` to test a different frame
- **Brand check:** Run `/brand-voice` if output feels off-tone
...
The full reference library — classic frameworks, headline formulas, opening line patterns, flow techniques, and modern examples — is in:

**`COPYWRITING_PLAYBOOK.md`** (same folder)
...
- Headline Formulas and Examples (15 types)
- Opening Lines and Hooks (10 types)
- Curiosity Gaps and Open Loops
- Flow Techniques: The Slippery Slide
- Modern Internet-Native Copy Examples

When writing copy, load `COPYWRITING_PLAYBOOK.md` for deeper frameworks and examples.
...
> "The Marketing & SEO community did $400k+ in 9 months."
